    ...
    return html`
      <a href="./#/detail/${this.restaurant.id}" class="card">
        <div class="card__header">
          <img src="${CONFIG.IMAGE_PLACEHOLDER}" data-src="${CONFIG.API_THUMBNAIL_IMG_PATH + this.restaurant.pictureId}" alt="Photo of ${this.restaurant.name}, a restaurant in ${this.restaurant.city}" class="card__image lazyload">
